...
```
$ git clone https://github.com/opportunity-zh/opp-php-pdo-example.git

$ cd opp-php-pdo-example
```
...
The images used by the setup are listed and configured in [`docker-compose.yml`](https://github.com/opportunity-zh/opp-php-pdo-example/docker-compose.yml).
